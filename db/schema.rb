...
ActiveRecord::Schema.define(version: 2019_02_22_002457) do
  ...
  create_table "song_slots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["billboard_id"], name: "index_song_slots_on_billboard_id"
    t.index ["song_id"], name: "index_song_slots_on_song_id"
  end
